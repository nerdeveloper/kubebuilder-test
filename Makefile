...
KIND_CLUSTER ?= kubebuilder-test-fresh-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kubebuilder-test-fresh-builder
	$(CONTAINER_TOOL) buildx use kubebuilder-test-fresh-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm kubebuilder-test-fresh-builder
	rm Dockerfile.cross
